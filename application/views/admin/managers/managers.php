        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>Health Management Organizations
                        <button class="btn btn-primary" data-target="#add-user" data-toggle="modal">
                            <i class="fa fa-plus" aria-hidden="true"></i> New HMO
                        </button>
                    </h1>
                    <ol class="breadcrumb">
                        <li class="active"><a href="/"><i class="fa fa-users"></i> HMOs</a></li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-9 mt25">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Health Management Organizations</h3>
