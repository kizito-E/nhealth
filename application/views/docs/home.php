...
<html lang="en">
<head>
    <title>nHealth | Documentation</title>
    <!-- Meta -->
    <meta charset="utf-8">
    ...
    <div class="page-wrapper">
        ...
        <header class="header text-center">
            <div class="container">
                ...
                <div class="tagline">
                    <p>e-Health Insurance Management System</p>
                    <p>Built with <i class="fas fa-heart"></i> by Elvis Kizito, Kuceli Englama, David Edijala & Izuchukwu Anointing</p>
                </div><!--//tagline-->
                 
                <div class="social-container">
	                <!-- Replace with your Github Button -->
	                <div class="github-btn mb-2">
						<a class="github-button" href="https://github.com/Kizito-E/nHealth" data-size="large" aria-label="Star xriley/PrettyDocs-Theme on GitHub">Star</a>
                        <a class="github-button" href="https://github.com/Kizito-E" data-size="large" aria-label="Follow @Kizito-E on GitHub">Follow @Kizito-E</a>
                        <a class="github-button" href="https://github.com/kuceli" data-size="large" aria-label="Follow @kuceli on GitHub">Follow @kuceli</a>
	                </div>
                ...
                <div id="cards-wrapper" class="cards-wrapper row">
                    <!--<div class="item item-green col-lg-4 col-6">
                        <div class="item-inner">
                            ...
                            <a class="link" href="/docs/guide"><span></span></a>
                        </div>
                    </div>-->
                    ...
                    <div class="item item-purple col-lg-4 col-6">
                        <div class="item-inner">
                            ...
                            <a class="link" href="/docs/faqs"><span></span></a>
                        </div><!--//item-inner-->
                    </div><!--//item-->
                </div><!--//cards-->
