            ...
            <div class="tab-content">
              <div class="tab-pane active show" id="tab-1">
                <div class="row">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="/assets/landing/img/departments-1.jpg" alt="" class="img-fluid">
                  </div>
                </div>
              </div>
              <div class="tab-pane" id="tab-2">
                <div class="row">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="/assets/landing/img/departments-2.jpg" alt="" class="img-fluid">
                  </div>
                </div>
              </div>
              <div class="tab-pane" id="tab-3">
                <div class="row">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="/assets/landing/img/departments-3.jpg" alt="" class="img-fluid">
                  </div>
                </div>
              </div>
              <div class="tab-pane" id="tab-4">
                <div class="row">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="/assets/landing/img/departments-4.jpg" alt="" class="img-fluid">
                  </div>
                </div>
              </div>
              <div class="tab-pane" id="tab-5">
                <div class="row">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="/assets/landing/img/departments-5.jpg" alt="" class="img-fluid">
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="/assets/landing/img/doctors/doctors-1.jpg" class="img-fluid" alt=""></div>
          ...
          <div class="col-lg-6 mt-4 mt-lg-0">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="/assets/landing/img/doctors/doctors-2.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Sarah Jhonson</h4>
          ...
          <div class="col-lg-6 mt-4">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="/assets/landing/img/doctors/doctors-3.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
          ...
          <div class="col-lg-6 mt-4">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="/assets/landing/img/doctors/doctors-4.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Amanda Jepson</h4>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="/assets/landing/img/gallery/gallery-1.jpg" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="/assets/landing/img/gallery/gallery-2.jpg" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="/assets/landing/img/gallery/gallery-3.jpg" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="/assets/landing/img/gallery/gallery-4.jpg" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="/assets/landing/img/gallery/gallery-5.jpg" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="/assets/landing/img/gallery/gallery-6.jpg" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="/assets/landing/img/gallery/gallery-7.jpg" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="/assets/landing/img/gallery/gallery-8.jpg" class="galelry-lightbox">
